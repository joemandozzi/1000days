...
# These are confirmed standalone texts (not collections) on Gutenberg.
STORIES = [
    ("The Yellow Wallpaper",       "Charlotte Perkins Gilman", 1892, 1952),
    ("The Turn of the Screw",      "Henry James",              1898, 6662),
    ("The Necklace",               "Guy de Maupassant",        1884, 3090),
    ("A White Heron",              "Sarah Orne Jewett",        1886, 369),
    ...
    ("The Diamond as Big as the Ritz", "F. Scott Fitzgerald", 1922, 45859),
    ("Bernice Bobs Her Hair",      "F. Scott Fitzgerald",      1920, 45862),
    ...
    ("The Cask of Amontillado",    "Edgar Allan Poe",          1846, 1062),
    ("The Tell-Tale Heart",        "Edgar Allan Poe",          1843, 2148),
    ("The Purloined Letter",       "Edgar Allan Poe",          1844, 2148),
    ("The Gift of the Magi",       "O. Henry",                 1905, 7256),
    ("The Ransom of Red Chief",    "O. Henry",                 1910, 7256),
